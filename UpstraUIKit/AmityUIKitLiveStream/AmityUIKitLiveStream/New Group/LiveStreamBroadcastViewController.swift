...
final public class LiveStreamBroadcastViewController: UIViewController {
    ...
    public init(client: AmityClient, targetId: String?, targetType: AmityPostTargetType) {
        ...
        NotificationCenter.default.addObserver(
            self,
            selector: #selector(livestreamDissmiss(_:)),
    ...
    deinit {
        ...
        NotificationCenter.default.removeObserver(self, name: Notification.Name("livestreamDissmiss"), object: nil)
    }
    ...
    private func setupViews() {
        ...
        NSAttributedString(string:"Livestream title", attributes: [NSAttributedString.Key.foregroundColor: UIColor.white])
