...
struct EnvironmentSettingModel: Codable {
    ...
    static func defaultConfig(for environment: EnvironmentType) -> EndpointConfigModel {
        return EndpointConfigModel(apiKey: "", httpEndpoint: AmityRegion.SG.httpUrl, socketEndpoint: AmityRegion.SG.rpcUrl, mqttEndpoint: AmityRegion.SG.mqttHost, uploadURL: AmityRegion.SG.uploadUrl)
    }
}
