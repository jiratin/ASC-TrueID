//
//  AmityPostLiveStreamTargetSelectionPage.swift
//  AmityUIKit4
//
//  Created by Thavorn Kamolsin on 13/11/2567 BE.
//

import SwiftUI

public struct AmityPostLiveStreamTargetSelectionPage: AmityPageView {
        ...
        VStack {
            ...
            TargetSelectionView(headerView: {
                VStack(spacing: 10) {
                    ...
                    .onTapGesture {
                        let context = AmityPostLiveStreamTargetSelectionPageBehaviour.Context(page: self, community: nil)
                        AmityUIKitManagerInternal.shared.behavior.postLiveStreamSelectionPageBehavior?.goToPostComposerPage(context: context)
                    }
                ...
                let context = AmityPostLiveStreamTargetSelectionPageBehaviour.Context(page: self, community: communityModel)
                AmityUIKitManagerInternal.shared.behavior.postLiveStreamSelectionPageBehavior?.goToPostComposerPage(context: context)
            }, contentType: .post)
        }
