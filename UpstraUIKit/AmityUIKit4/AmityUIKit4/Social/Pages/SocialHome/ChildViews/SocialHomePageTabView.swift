...
struct SocialHomePageTabView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            tabItems = tabItems.compactMap({ item in
                ...
                if viewConfig.isHidden(elementId: .popularButton) && item.tab == .popularFeed {
                    return nil
                }
    ...
    private func getTitle(tab: AmitySocialHomePageTab) -> String {
        switch tab {
        case .popularFeed:
            return viewConfig.getConfig(elementId: .popularButton, key: "text", of: String.self) ?? ""
        case .newsFeed:
    ...
    private func getAccessibilityID(tab: AmitySocialHomePageTab) -> String {
        switch tab {
        case .popularFeed: AccessibilityID.Social.SocialHomePage.popularCommunitiesButton
