...
class AppManager {
    ...
    func setupAmityUIKit() {
        ...
        AmityUIKit4Manager.setUrlAdvertisement("")
        AmityUIKit4Manager.set(feedEventHandler: CustomUIKit4FeedEventHandler())
        AmityUIKit4Manager.set(eventHandler: CustomUIKit4EventHandler())
        AmityUIKit4Manager.setJWTAccessToken("")
        ...
        #if canImport(AmityUIKit4)
        AmityUIKit4Manager.setup(client: AmityUIKitManager.client,trueIDEnvType: .staging, trueIDCountry: .thailand)
