...
open class AmityUIKitBehaviour {
    ...
    public var popularFeedComponentBehavior: AmityPopularFeedComponentBehavior?
    public var postLiveStreamSelectionPageBehavior: AmityPostLiveStreamTargetSelectionPageBehaviour?
    public var myCommunitiesHeaderComponentBehavior: AmityMyCommunitiesHeaderComponentBehavior?
}
